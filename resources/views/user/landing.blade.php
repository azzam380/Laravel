                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link ml-auto text-white"
                             style="text-decoration: underline">{{Auth::guard('masyarakat')->user()->name}}</a>
                        </li>
                    </ul>
@else
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <button class="btn text-white" class="btn btn-warning" type="button"  data-toggle="modal" data-target="#loginModal">
                            Login
                            </button>
                        </li>
    ...
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            @endif
             ...
             <div class="card mb-3">Create Yout Report Here</div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 Azzam | All rights reserved</p>
    </div>
</div>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body">
            ...
            <p>Please Login With Registred Account.</p>
            <form action="#" method="POST">
                @csrf
                <div class="form-group">
                    <label for="usernamd">Username</label>
